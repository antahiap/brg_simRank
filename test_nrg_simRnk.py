...
class TestSimRank():
    ...
    def test_simRank_extnd(self):
        ...
        def simRank_pair(
            ...
            cypherTxt = query.simrank_G(nFrmt, nFrmtM, pidMax)
        ...
        nFrmt = '"CCSA_submodel_1.*"'
        nFrmtM = '"CCSA_submodel_00[2].*"'
        key_ref1 = ['0021', '0022', '0023', '0024', '0025']
        ...
        nFrmt = '"CCSA_submodel_[12].*"'
        nFrmtM = '"CCSA_submodel_00[12].*"'
        key_ref3 = key_ref1 + key_ref2
        simExt3 = pd.concat([simExt10, simExt20])
        simExt3 = simExt3.reset_index(drop=True)
        simExt3 = simExt3.assign(dt_ui='0.4-0.6')
        simExt3 = simRank_pair(query, nFrmt, nFrmtM, simExt3, key_ref3)

        simExt = pd.concat([simExt1, simExt2, simExt3])
        color_discrete_map = {'0011': 'blue', '0012': 'yellow', '0013': 'red', '0014': 'green', '0015': 'magenta', 'miss result': 'gray',
                              '0021': 'blue', '0022': 'yellow', '0023': 'red', '0024': 'green', '0025': 'magenta'}
        ...
        # print(top)
        # print(slct_subm)
        # for i, sub in enumerate(slct_subm):
        #     sId = sName[top[i]]
        #     print(sId, key_ref[sub])
    ...
    def test_simRank_extnd_IE(self):
        ...
        lmt = 5
        read = False  # True
        outPath = "./sims_extnd_IE_rmse.pkl"

        if read:
            sims_1 = [11, 12, 13, 14, 15]
            random.shuffle(sims_1)
            input(sims_1)
            simExt_1 = pd.read_pickle("extnd_mdl/sims_extnd_02.pkl")
            simExt_1['data_id'] = 1
            ...
            input(sims_2)
            simExt_2 = pd.read_pickle("extnd_mdl/sims_extnd_01.pkl")
            simExt_2['data_id'] = 2
            simExt_2 = sort_IE_sim(query, nFrmt, nFrmt1, sims_2, simExt_2, lmt)
            ...
            simExt = pd.concat([simExt_1, simExt_2, simExt_3])
